...
-- Administration MARKI : platform@marki.test / MarkiAdmin2026!
-- ============================================================================
...
-- Comptes individuels de l'administration MARKI.
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = 'La table platform_admins manque.';
    END IF;
END$$
DELIMITER ;
...
TRUNCATE TABLE platform_admin_activity_logs;
TRUNCATE TABLE platform_admin_sessions;
...
-- Courriel : platform@marki.test
-- Mot de passe : MarkiAdmin2026!
INSERT INTO platform_admins (
    ...
    1,
    'platform@marki.test',
    '$2y$12$taYOGaBOlzZUE4bgzH8FLubMMFj2fv/kbumEcWcPyOEsDcbv3EgjC',
    'Administrateur MARKI',
    'active',
    0,
    NULL,
    NULL,
...
ALTER TABLE platform_admins AUTO_INCREMENT = 2;
...
-- Résumé de contrôle.
SELECT 'platform_admins' AS element, COUNT(*) AS total FROM platform_admins
UNION ALL
